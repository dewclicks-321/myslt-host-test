...
const BroadbandPrepaidMainPackages: React.FC = () => {
  ...
  const handleConfirmActivation = async () => {
    ...
    const pkgName = packages[selectedPackageIndex!]?.OFFERING_NAME || packages[selectedPackageIndex!]?.MYSLT_PKG_NAME;
    ...
    >
      ...
      >
        {packages.map((pkg, index) => (
          ...
          >
            {/* Right-aligned blue top section with curved bottom */}
            <Box
              sx={{
                bgcolor: "#17A1FA", // Blue background
                height: "120px",
